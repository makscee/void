...
# This script is served by the Overseer itself
# Usage: curl -fsSL http://<overseer-host>:8000/install-web.sh | bash
# Or: bash <(curl -fsSL http://<overseer-host>:8000/install-web.sh)
#
# Version: 1.0.0
